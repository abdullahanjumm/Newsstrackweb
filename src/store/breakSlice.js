...
const adminSlice = createSlice({
    ...
    reducers: {
        ...
        setTimeField: (state, action) => {
            const { employeeId, startTime, endTime, showFields } = action.payload;
            state.timeFields[employeeId] = { startTime, endTime, showFields };
        },
        resetTimeFields: (state) => {
            state.timeFields = {};
        },
